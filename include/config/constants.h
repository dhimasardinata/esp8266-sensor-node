...
namespace AppConstants {
  ...
  constexpr unsigned long OTA_WEB_STALL_TIMEOUT_MS = REDACTED
  constexpr unsigned long OTA_WEB_MAX_DURATION_MS = REDACTED
  constexpr unsigned long OTA_ARDUINO_STALL_TIMEOUT_MS = REDACTED
  constexpr unsigned long OTA_ARDUINO_MAX_DURATION_MS = REDACTED
  constexpr unsigned long OTA_CLOUD_STALL_TIMEOUT_MS = REDACTED
  constexpr unsigned long OTA_CLOUD_MAX_DURATION_MS = REDACTED
  ...
  constexpr unsigned long BH1750_READ_INTERVAL_MS = 2000;
  ...
  constexpr uint32_t WS_REPLAY_SKEW_SEC_STRICT = 30;                  // Tight window when NTP verified
  constexpr uint32_t WS_REPLAY_SKEW_SEC_SOFT = 300;                   // Relaxed window for manual/cached time
  constexpr uint32_t WS_REPLAY_SKEW_SEC_MAX = 900;                    // Hard cap for replay tolerance
  ...
  constexpr uint32_t TLS_MIN_SAFE_BLOCK_SIZE = 4096;   // Minimum contiguous block for TLS
  ...
  constexpr uint16_t TLS_TX_BUF_SIZE = 1024;
