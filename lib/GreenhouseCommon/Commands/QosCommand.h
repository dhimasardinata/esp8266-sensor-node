...
public:
  ...
  uint32_t getNameHash() const override { return CompileTimeUtils::ct_hash("qos-upload"); }
...
public:
  ...
  uint32_t getNameHash() const override { return CompileTimeUtils::ct_hash("qos-ota"); }
  const char* getDescription() const override {
