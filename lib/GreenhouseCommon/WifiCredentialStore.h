...
struct WifiCredential {
    ...
    bool isHidden = false;    // Hidden network (attempt connection even if not scanned)
...
private:
    ...
    void sortByRssi();
    void resetAvailability();  // Helper for updateFromScan
    ...
    static constexpr uint32_t CREDENTIAL_MAGIC = 0xCAFE1235; // Increment for hidden flag
};
