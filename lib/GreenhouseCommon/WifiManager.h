...
private:
  ...
  void processRoamingScanResults();  // New: Process async roaming scan
  ...
  bool m_roamingScanInProgress = false;  // New: Track roaming scan state
  int32_t m_roamingCurrentRssi = 0;      // New: RSSI at scan trigger
