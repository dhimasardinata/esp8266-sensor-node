...
public:
  ...
  [[nodiscard]] static bool saveTempWifiCredentials(std::string_view ssid, std::string_view password, bool hidden = false);
  static void loadTempWifiCredentials(std::span<char> ssid_buf, std::span<char> pass_buf, bool& hidden);
