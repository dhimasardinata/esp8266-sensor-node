...
public:
  ...
  [[nodiscard]] ScanRequestStatus requestNetworkScan();
  [[nodiscard]] bool captureScanSnapshotFromWifi(int scanCount);
  ...
  [[nodiscard]] bool hasScanSnapshot() const noexcept;
...
private:
  ...
  bool m_hasScanSnapshot = false;
  mutable unsigned long m_scanSnapshotLastAccess = 0;
  ...
  bool m_snapshotScanRequested = false;
  bool m_snapshotScanInProgress = false;
  ...
  std::array<IWifiStateObserver*, 5> m_observers;
