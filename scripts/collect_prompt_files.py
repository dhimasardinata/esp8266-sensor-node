...
SOURCE_DIR = '.'
DEST_DIR = os.path.join('tools', 'prompt')
...
IGNORED_DIRS = {
    '.pio', '.vscode', '.github', '.git', '__pycache__', 'tools', 'node_modules', '.devcontainer', 'var'
}
    ...
    for root, dirs, files in os.walk(SOURCE_DIR):
        ...
        for file in files:
            if is_allowed(file):
                ...
                # e.g., lib/NodeCore/support/Utils.h -> lib_NodeCore_support_Utils.h
