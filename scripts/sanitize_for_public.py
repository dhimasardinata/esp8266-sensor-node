...
ota_ip_9 =
ota_ip_10 =
gateway_ip_1 = 192.168.1.100
gateway_ip_2 =
""",
    "include/config/calibration.h": '''// calibration.h
...
''',
    "include/generated/certs.h": """#ifndef CERTS_H
#define CERTS_H

#include <Arduino.h>

// PLACEHOLDER: Generate your own SSL certificate and key
// Use: openssl req -x509 -newkey rsa:2048 -keyout key.pem -out tools/certs/dev-cert.pem -days 3650 -nodes
...
#endif  // CERTS_H
""",
    "lib/NodeCore/support/CryptoUtils.h": '''#ifndef CRYPTO_UTILS_H
